...
<meta property="og:image" content="https://github.com/GlobalTechInfo.png">
...
<style>
  @keyframes vibrate {
    0% { transform: translateX(-50%) translateY(-50%) rotate(1deg); }
    50% { transform: translateX(-50%) translateY(-50%) rotate(-1deg); }
    100% { transform: translateX(-50%) translateY(-50%) rotate(1deg); }
  }
</style>
<script>
  function createVibratingButton() {
    const homeButton = document.createElement('button');
    homeButton.textContent = 'Home';
    homeButton.style.position = 'fixed';
    homeButton.style.bottom = '15vh';
    homeButton.style.left = '50%';
    homeButton.style.transform = 'translateX(-50%) translateY(-50%)'; 
    homeButton.style.background = 'linear-gradient(to bottom, #000033, #000066)';
    homeButton.style.color = 'white';
    homeButton.style.fontWeight = 'normal';
    homeButton.style.border = '2px solid #00FFFF';
    homeButton.style.textTransform = 'uppercase';
    homeButton.style.cursor = 'pointer';
    homeButton.style.padding = '1vh 4vw'; 
    homeButton.style.opacity = '0';
    homeButton.style.transition = 'opacity 0.5s ease-in-out';
    document.body.appendChild(homeButton);
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      homeButton.style.fontSize = '1.3em'; 
    }
    setTimeout(function() {
      ...
      setTimeout(function() {
        ...
        setTimeout(function() {
          homeButton.style.animation = 'vibrate 3s ease infinite';
        }, 1000);
      }, 3000);
    }, 100);
  ...
  createVibratingButton();
  setInterval(createVibratingButton, 5000);
</script>
</body>
</html>`;
